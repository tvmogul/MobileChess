...
var chess = (function () {
	...
	nDeskWidth = 354, nDeskHeight = 354, nFlatBVMargin = 12, // theese values are modificable
    nFlatBoardSide = nDeskHeight - nFlatBVMargin, nPageX, nPageY, iBoardsBoxX, iBoardsBoxY, nDscrsX, nDscrsY, oFilm, nMinWidth = nMinHeight = 354,
    ...
    */
    ...
    //WS
    function setSizeChessBoard(nDeskWidth, nDeskHeight) {
        setStyles.call(oFilm, ["width", nDeskWidth + "px"], ["height", nDeskHeight + "px"], ["left", iBoardsBoxX + "px"], ["top", iBoardsBoxY + "px"]);
        //Canvas3D.removeEvent(document, "mousemove", resizeFilm);
        //Canvas3D.removeEvent(document, "mouseup", stopResizing);
        etc.i3DHeight = nDeskHeight;
